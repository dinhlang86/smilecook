...
# The list of unique tokens logged out
black_list = set()
...
class TokenResource(Resource):
    ...
    def post(self):
        ...
        if not user or not check_password(password, user.password):
            return {'message':'user or password is incorrect'}, HTTPStatus.UNAUTHORIZED
...
class RevokeResource(Resource):
    ...
    def post(self):
        jti = get_jwt()['jti']
        black_list.add(jti)
        return {'message':'Successful logged out'}, HTTPStatus.OK
